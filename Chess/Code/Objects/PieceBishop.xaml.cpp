//
// PieceBishop.xaml.cpp
// Implementation of the PieceBishop class
//

#include "pch.h"
#include "PieceBishop.xaml.h"
...
PieceBishop::PieceBishop(int Color)
{
	this->Color = Color;
	switch (Color)
	{
...
void PieceBishop::setColor(int x)
{
	this->Color = x;
